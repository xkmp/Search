...
public enum ItemIDSunName {
	...
	private static final HashMap<String, String> path = new HashMap<String, String>();
	private static final HashMap<String, Map<String, Object>> NAME_MAP = new HashMap<String, Map<String, Object>>();
	private static final HashMap<String, Map<String, Object>> ID_MAP = new HashMap<String, Map<String, Object>>();
	private static final HashMap<String, ItemIDSunName> ItemIDSunName_MAP = new HashMap<String, ItemIDSunName>();
	private static final ArrayList<HashMap<String, Object>> All = new ArrayList<HashMap<String, Object>>();
	static {
	...
	public static int getNameByID(String Name) {
		Map<String, Object> map = NAME_MAP.get(Name);
	...
	public static int getNameByDamage(String Name) {
		Map<String, Object> map = NAME_MAP.get(Name);
		if (map == null || map.get("Damage") == null)
			return 0;
	...
	public static ItemIDSunName getItem(int ID, int Damage) {
		return ItemIDSunName_MAP.get(ID + ":" + Damage);
	}
